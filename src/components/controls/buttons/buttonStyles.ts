...
// Primary matches the Maha reference's CTA color (#0bceaf teal) exactly;
// the soft accent-tinted shadow + darken-on-hover (instead of brighten —
// white text washes out on an even lighter teal) make it read as clickable.
